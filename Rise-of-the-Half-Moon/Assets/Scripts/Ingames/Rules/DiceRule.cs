...
public class DiceRule : ContentRule
{
    ...
    protected override bool IsCombination(int index1, int index2)
    {
        ...
        return (index1 == 1 && index2 == 6) || // Example combination
               (index1 == 2 && index2 == 5) || // Example combination
               (index1 == 3 && index2 == 4) || // Example combination
               (index1 == 4 && index2 == 3) || // Example combination
               (index1 == 5 && index2 == 2) || // Example combination
               (index1 == 6 && index2 == 1);   // Example combination
    }
